...
/**
 * EffectReactivityControl - Controle de sensibilidade/reatividade normalizado compartilhado
 * 
 * Todos os efeitos visuais usam valores normalizados (0-1) para sensibilidade ao áudio.
...
withDefaults(defineProps<Props>(), {
    ...
    controlId: 'effect-reactivity-control',
    description: ''
})
